...
# 51 "C:\\Users\\BALLY.GIGATMS\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\string.h" 3
...
{
    uint32_t u32IntSrc = ((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->INTSTS;
    if (u32IntSrc & 0x11) {
        while (((((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->FIFOSTS & (0x1ul << (14))) == 0) && (bufhead < 64)) {
            uart_rcvbuf[bufhead++] = ((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->DAT;
        }
    }
    if (bufhead == 64) {
        bUartDataReady = (1UL);
...
void PutString(void)
{
    uint32_t i;
    for (i = 0; i < 64; i++) {
        while ((((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->FIFOSTS & (0x1ul << (23))));
        ((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->DAT = response_buff[i];
    }
}

void UART_Init(void)
{
    ((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->FUNCSEL = ((((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->FUNCSEL & (~(0x7ul << (0)))) | ((0x0ul << (0))));
    ((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->LINE = (3ul) | (0x0ul << (3)) | (0x0ul << (2));
    ((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->FIFO = (0x3ul << (4)) | (0x3ul << (16))
                   | (0x1ul << (2)) | (0x1ul << (1));
    ((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->BAUD = (((0x1ul << (29)) | (0x1ul << (28))) | (((((48000000UL)) + ((115200)/2ul)) / (115200))-2ul));
    ((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->TOUT = (((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->TOUT & ~(0xfful << (0))) | (0x40);
    NVIC_SetPriority(UART13_IRQn, 2);
    NVIC_EnableIRQ(UART13_IRQn);
    ((UART_T *) ((( uint32_t)0x40000000) + 0x71000))->INTEN = ((0x1ul << (11)) | (0x1ul << (4)) | (0x1ul << (0)));
}
